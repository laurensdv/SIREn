...
public class TestSiren02DocNodAndPosEnum extends BasicSirenTestCase {

  @Override
  protected void configure() throws IOException {
    this.setAnalyzer(AnalyzerType.TUPLE);
    this.setPostingsFormat(PostingsFormatType.SIREN_02);
  }

  protected Siren02DocsNodesAndPositionsEnum getEnum(final String term) throws IOException {
    final BytesRef ref = new BytesRef(term);
    final AtomicReader r = (AtomicReader) reader;
    final DocsAndPositionsEnum e = r.termPositionsEnum(r.getLiveDocs(), DEFAULT_TEST_FIELD, ref, false);
    return new Siren02DocsNodesAndPositionsEnum(e);
  }
  ...
  throws Exception {
    ...
    final Siren02DocsNodesAndPositionsEnum termEnum = this.getEnum("word1");
  ...
  throws Exception {
    ...
    final Siren02DocsNodesAndPositionsEnum termEnum = this.getEnum("word3");
  ...
  throws Exception {
    ...
    final Siren02DocsNodesAndPositionsEnum termEnum = this.getEnum("aaa");
  ...
  throws Exception {
    ...
    final Siren02DocsNodesAndPositionsEnum termEnum = this.getEnum("bbb");
  ...
  public void testVariableNodeLength() throws Exception {
    ...
    this.addDocuments(
      ...
      doc(token("aaa", node(1,0,1,0)), token("aaa", node(2,0)))
    );
