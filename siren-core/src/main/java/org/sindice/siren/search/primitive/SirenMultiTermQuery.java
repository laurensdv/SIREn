 ...
 * NodeBooleanQuery#getMaxClauseCount()}.
 *
 ...
 */
public abstract class SirenMultiTermQuery extends NodePrimitiveQuery {
...
//      return result;
   ...
   * @see #setRewriteMethod
   */
  public static final class TopTermsScoringSirenBooleanQueryRewrite extends SirenTopTermsRewrite<NodeBooleanQuery> {
    ...
    @Override
    protected void addClause(final NodeBooleanQuery topLevel, final Term term, final float boost) {
      final NodeTermQuery tq = new NodeTermQuery(term);
      tq.setBoost(boost);
  ...
  /**
   * A rewrite method that first translates each term into
   * {@link NodeBooleanClause.Occur#SHOULD} clause in a SirenBooleanQuery, but
   ...
   * @see #setRewriteMethod
   */
  public static final class TopTermsBoostOnlySirenBooleanQueryRewrite extends SirenTopTermsRewrite<NodeBooleanQuery> {
    ...
    @Override
    protected void addClause(final NodeBooleanQuery topLevel, final Term term, final float boost) {
      final NodePrimitiveQuery q = new SirenConstantScoreQuery(new NodeTermQuery(term));
      q.setBoost(boost);
   ...
   */
  public static class SirenConstantScoreAutoRewrite extends org.sindice.siren.search.primitive.SirenConstantScoreAutoRewrite {}
