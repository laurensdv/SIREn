...
import org.sindice.siren.search.primitive.SirenMultiTermQuery.RewriteMethod;
...
public abstract class SirenScoringRewrite<Q extends Query> extends SirenTermCollectingRewrite<Q> {
   ...
   **/
  public final static SirenScoringRewrite<NodeBooleanQuery> SCORING_BOOLEAN_QUERY_REWRITE = new SirenScoringRewrite<NodeBooleanQuery>() {
    @Override
