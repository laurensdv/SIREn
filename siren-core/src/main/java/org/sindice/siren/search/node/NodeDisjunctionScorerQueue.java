...
/**
 * A NodeDisjunctionScorerQueue maintains a partial ordering of its Scorers such that the
 * least Scorer can always be found in constant time. This allows to retrieve
 * in order all matching documents and nodes from multiple scorers, as if they
 * were one stream.
 * <p>
 ...
 */
public class NodeDisjunctionScorerQueue {
