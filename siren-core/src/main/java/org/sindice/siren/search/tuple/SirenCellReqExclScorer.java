 ...
 * subscorer are kept.
 * <p> The subscorer are not constrained to be {@link NodePrimitiveScorer}
...
extends NodeScorer {
   ...
   */
  private NodeScorer reqScorer, exclScorer;
   ...
   *          indicates exclusion.
   */
  public SirenCellReqExclScorer(final NodeScorer reqScorer,
