 ...
 */
public class SirenConstantScoreAutoRewrite extends SirenTermCollectingRewrite<NodeBooleanQuery> {
  ...
  @Override
  protected void addClause(final NodeBooleanQuery topLevel, final Term term, final float boost /*ignored*/) {
    topLevel.add(new NodeTermQuery(term), Occur.SHOULD);
  }
