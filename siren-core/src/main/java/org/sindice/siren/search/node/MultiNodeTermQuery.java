...
//      return result;
   ...
   * @see #setRewriteMethod
   */
  public static final class TopTermsScoringNodeBooleanQueryRewrite extends TopNodeTermsRewrite<NodeBooleanQuery> {
   ...
   * @see #setRewriteMethod
   */
  public static final class TopTermsBoostOnlyNodeBooleanQueryRewrite extends TopNodeTermsRewrite<NodeBooleanQuery> {
   ...
   */
  public static class NodeConstantScoreAutoRewrite extends org.sindice.siren.search.node.NodeConstantScoreAutoRewrite {}
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(other.ancestor == null ? ancestor == null : ancestor.equals(other.ancestor))) {
      return false;
    }
