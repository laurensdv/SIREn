 ...
 */
public class SlopQueryNodeBuilder implements NodeQueryBuilder {
  ...
  public NodePhraseQuery build(QueryNode queryNode) throws QueryNodeException {
    ...
    NodePhraseQuery query = (NodePhraseQuery) phraseSlopNode.getChild().getTag(QueryTreeBuilder.QUERY_TREE_BUILDER_TAGID);
    return query;
