 ...
 * All rights reserved.
 */
package org.sindice.siren.qparser.tree.ntriple.parser;
...
public class NTripleQParserImplTest {
  ...
  throws CorruptIndexException, LockObtainFailedException, IOException, ParseException {
    final String ntriple = "<news://s.org> <http://p.org> <http://o.org> .";
    final String query = " <news://s.org OR http://notMe.org> <http://p.org> <http://o.org>";
  ...
  throws CorruptIndexException, LockObtainFailedException, IOException, ParseException {
    ...
    final String query = " <http://s.org && http://notMe.org> <http://p.org> <http://o.org>";

    assertTrue(TupleQueryParserTestHelper.match(ntriple, query) == false);
  }
  ...
  throws CorruptIndexException, LockObtainFailedException, IOException, ParseException {
    final String ntriple = "<http://ane.org> <http://p.org> <http://o.org> .";
    final String query = " <NOT http://steph.org AND http://ane.org> <http://p.org> <http://o.org>";
  ...
  throws Exception {
    final String ntriple = "<http://s.org> <http://p.org> <http://o1.org> <http://o2.org> .";
    final String query = " <http://s.org> <http://p.org> <http://o2.org || http://o5.org>";
