...
/**
 * Benchmark to check what is the more efficient way to check the equality of
 * two nodes. The first method is based on copying the node to a private IntsRef
 * and then compare the equality of two IntsRef. The second method is based on
 * comparing the hash of the IntsRef.
 */
