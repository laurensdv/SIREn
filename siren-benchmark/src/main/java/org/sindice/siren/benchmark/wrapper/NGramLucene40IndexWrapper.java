...
public class NGramLucene40IndexWrapper extends AbstractLucene40IndexWrapper {

  public NGramLucene40IndexWrapper(final File path) throws IOException {
    super(path);
  }
